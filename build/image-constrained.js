...
/* harmony import */ var _image__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./image */ "./includes/block-editor/blocks/image-constrained/image.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./editor.scss */ "./includes/block-editor/blocks/image-constrained/editor.scss");
...
function Edit(_ref) {
  ...
  */
  ...
  const classes = classnames__WEBPACK_IMPORTED_MODULE_1___default()(className, 'size-full', {
  ...
  }), !url && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.BlockControls, {
    group: "block"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.BlockAlignmentControl, {
    value: align,
    onChange: updateAlignment
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.MediaPlaceholder, {
    multiple: false,
    labels: {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Image [Size Constrained]'),
      instructions: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Upload an image file, or pick one from the media library.')
    },
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/crop.js");
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/overlay-text.js");
...
/* harmony import */ var _use_client_width__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./use-client-width */ "./includes/block-editor/blocks/image-constrained/use-client-width.js");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./edit */ "./includes/block-editor/blocks/image-constrained/edit.js");
...
function Image(_ref) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (isSelected && (0,_edit__WEBPACK_IMPORTED_MODULE_13__.isMediaDestroyed)(id)) {
      onImageLoadError();
    }
  }, [isSelected]);
  ...
  if (alt) {
    ...
    defaultedAlt = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.sprintf)( // eslint-disable-next-line @wordpress/i18n-translator-comments
...
function save() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("figure", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save(), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Image [Constrained]', 'resource-blocks'));
}

/***/ }),

/***/ "./includes/block-editor/blocks/image-constrained/use-client-width.js":
/*!****************************************************************************!*\
  !*** ./includes/block-editor/blocks/image-constrained/use-client-width.js ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"resource-blocks/image-constrained","version":"1.0.0","title":"Image [Size Constrained]","category":"resource-blocks","description":"A simple image that has an additional field to constrain the width or height.","keywords":["img","photo","picture"],"attributes":{"align":{"type":"string"},"url":{"type":"string","source":"attribute","selector":"img","attribute":"src"},"alt":{"type":"string","source":"attribute","selector":"img","attribute":"alt","default":""},"caption":{"type":"string","source":"html","selector":"figcaption"},"title":{"type":"string","source":"attribute","selector":"img","attribute":"title"},"href":{"type":"string","source":"attribute","selector":"figure > a","attribute":"href"},"rel":{"type":"string","source":"attribute","selector":"figure > a","attribute":"rel"},"linkClass":{"type":"string","source":"attribute","selector":"figure > a","attribute":"class"},"id":{"type":"number"},"width":{"type":"number"},"designWidth":{"type":"number"},"height":{"type":"number"},"designHeight":{"type":"number"},"linkDestination":{"type":"string"},"linkTarget":{"type":"string","source":"attribute","selector":"figure > a","attribute":"target"}},"supports":{"anchor":true,"color":{"__experimentalDuotone":"img","text":false,"background":false},"__experimentalBorder":{"radius":true,"__experimentalDefaultControls":{"radius":true}}},"styles":[{"name":"default","label":"Default","isDefault":true},{"name":"rounded","label":"Rounded"}],"textdomain":"resource-blocks","editorScript":"file:../../../../build/image-constrained.js","editorStyle":"file:../../../../build/image-constrained.css","style":"file:../../../../build/style-image-constrained.css"}');
